...
bot = telepot.Bot("8390589614:AAFDR1ql3g0FyJgjdNqUQqqpg1n_Kbfj6Ag")
CHANNEL_ID = "7895511617"
...
def get_thingspeak_data():
    try:
        data = requests.get("https://api.thingspeak.com/channels/3048446/feeds.json?api_key=YTPYMFD2WJGLYBMX&results=2")
        if data.status_code == 200:
            ...
            if feeds:
                ...
                return {
                    ...
                    'temperature': latest.get('field2'),
                    'ecg': latest.get('field3')
                }
